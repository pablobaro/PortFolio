jQuery("#simulation")
  .on("click", ".s-953ed244-b41f-44cc-9e76-482d695699fc .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Union_7")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    ...
                    "fields": {
                      ...
                      "dbd250a0-4c24-4a80-a112-0a68108ac260": null,
                      "9aa2a6c6-138c-4260-bebc-b571b9d1027a": null,
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "isexternal": true,
                    "target": "https://pablobaro.github.io/web4justinmind/",
                    "tab": true
                  },
                  "exectype": "serial",
                  "delay": 0
  ...
  .on("keyup.jim", ".s-953ed244-b41f-44cc-9e76-482d695699fc .keyup", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("keydown.jim", ".s-953ed244-b41f-44cc-9e76-482d695699fc .keydown", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("focusin", ".s-953ed244-b41f-44cc-9e76-482d695699fc .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("focusout", ".s-953ed244-b41f-44cc-9e76-482d695699fc .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
